...
public class QuickScanService implements QuickScanListener {
    ...
    @Override
    public Observable<List<ScanResult>> getAllResult(final Context context, final List<String> end) {
    ...
    private List<ScanResult> queryFiles(Context context, List<String> end) {
